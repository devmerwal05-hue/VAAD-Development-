        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-10 relative z-10">
          ...
          >
            ...
            <h1 style={{ fontFamily: 'Bebas Neue', fontSize: 'clamp(50px,9vw,96px)', letterSpacing: '0.03em', textTransform: 'uppercase', lineHeight: 0.93, color: '#F0EDE6', marginBottom: '20px' }}>
              {getContentValue('services_page', 'title_before', 'Design and engineering for teams that need a')}{' '}
              <span style={{ color: '#00B4FF' }}>{getContentValue('services_page', 'title_highlight', 'working release')}</span>
            </h1>
