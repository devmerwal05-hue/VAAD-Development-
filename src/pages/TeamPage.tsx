...
export default function TeamPage() {
  ...
  usePageMetadata({
    ...
    description: getContentValue('seo', 'team_description', 'Meet the small delivery team behind VAAD Development and how the work is split across design, engineering, and project delivery.'),
    path: '/team',
  });
