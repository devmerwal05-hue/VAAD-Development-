  ...
  return (
    <PageWrapper>
      ...
      <section className="section-pad swiss-section relative">
        <span className="swiss-meta swiss-meta--tl">{getContentValue('process_page', 'cta_meta_left', 'process.cta')}</span>
        <span className="swiss-meta swiss-meta--tr">{getContentValue('process_page', 'cta_meta_right', 'prompt // 03')}</span>
