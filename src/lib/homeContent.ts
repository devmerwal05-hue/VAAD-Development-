...
export const footerDefaults = {
  ...
  cta_title_highlight: 'build?',
  cta_description: "Let's turn your idea into a live product.",
  cta_button: 'Get In Touch',
  tagline: 'Building the web for businesses that mean it.',
  ...
  connect_1_label: 'LinkedIn',
  connect_1_href: '#',
  connect_2_label: 'Instagram',
  connect_2_href: '#',
  connect_3_label: 'GitHub',
  connect_3_href: '#',
  copyright: 'Copyright 2026 VAAD Development. All rights reserved.',
  made_by: 'Made by VAAD — obviously.',
};
...
const footerFields: AdminFieldDefinition[] = [
  ...
  { key: 'cta_title_highlight', label: 'Footer CTA highlight', fallback: footerDefaults.cta_title_highlight, description: 'Optional. If present inside the CTA title, it will be rendered with gradient.' },
  ...
  { key: 'pages_title', label: 'Pages column title', fallback: footerDefaults.pages_title },
  { key: 'services_title', label: 'Services column title', fallback: footerDefaults.services_title },
  { key: 'connect_title', label: 'Connect column title', fallback: footerDefaults.connect_title },
  ...
  { key: 'connect_1_label', label: 'Connect link 1 label', fallback: footerDefaults.connect_1_label },
  { key: 'connect_1_href', label: 'Connect link 1 URL', fallback: footerDefaults.connect_1_href, type: 'url' },
  { key: 'connect_2_label', label: 'Connect link 2 label', fallback: footerDefaults.connect_2_label },
  { key: 'connect_2_href', label: 'Connect link 2 URL', fallback: footerDefaults.connect_2_href, type: 'url' },
  { key: 'connect_3_label', label: 'Connect link 3 label', fallback: footerDefaults.connect_3_label },
  { key: 'connect_3_href', label: 'Connect link 3 URL', fallback: footerDefaults.connect_3_href, type: 'url' },
