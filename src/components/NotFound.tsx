      ...
      <main id="page-content" className="relative swiss-section flex min-h-[88svh] items-center border-b border-white/5 pt-[72px]">
        ...
        <div className="site-container swiss-grid relative z-10">
          <motion.div
            ...
            className="corner-marks swiss-full-col border border-[rgba(232,19,42,0.22)] bg-[rgba(9,22,40,0.78)] px-8 py-12 text-center md:px-12 lg:col-span-6 lg:col-start-4"
          >
            ...
            <p className="reading-track mx-auto mb-8 text-[15px] leading-[1.8] text-[rgba(234,230,219,0.58)]" style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 300 }}>
              {getContentValue(
                'not_found',
                'description',
