          ...
          {({ getContentValue }) => (
            <div className="min-h-screen bg-page-bg flex items-center justify-center px-6">
              <div className="text-center max-w-md">
                ...
                <button onClick={() => window.location.reload()} className="gradient-bg text-white px-6 py-3 rounded-xl text-[14px] font-medium" style={{ fontFamily: 'DM Sans', fontWeight: 500 }}>
